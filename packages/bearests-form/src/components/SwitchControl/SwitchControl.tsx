...
export default memo(SwitchControl, deepCompare);
...
const HiddenCheckbox = styled.input`
  //opacity: 0;
    ...
    &:checked + ${FakeSlider} {
        background-color: ${props => props.theme.primaryColor ?? '#2196F3'};
    ...
    :focus +  ${FakeSlider} {
      box-shadow: 0 0 1px ${props => props.theme.primaryColor ?? '#2196F3'};
    }
